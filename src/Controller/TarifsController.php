...
{
    #[Route('/tarifs', name: 'app_tarifs_index', methods: ['GET'])]
    ...
    #[Route('/tarifs/new', name: 'app_tarifs_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/tarifs/{id}', name: 'app_tarifs_show', methods: ['GET'])]
    ...
    #[Route('/tarifs/{id}/edit', name: 'app_tarifs_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/tarifs/{id}', name: 'app_tarifs_delete', methods: ['POST'])]
